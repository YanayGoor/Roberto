/**
  ...
  *            
  *          The file is the unique stm32f4 file that the application programmer
...
#if !defined (STM32F4XX)
 #error "Please select first the target STM32F4XX device used in your application (in stm32f4.h file)"
#endif
